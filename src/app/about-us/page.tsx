...
export default function Page() {
  return (
    <div className="bg-[#121212] text-white w-full flex flex-col items-center">
      {/* Header */}
      <div className="w-full text-center  py-10 md:py-16 relative overflow-hidden">
        <div
      ...
      <div className="container max-w-5xl px-4 py-10 flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-[#AFAFAF] text-lg md:text-2xl">
          That&apos;s the heart of our mission.
        </p>
      </div>

      {/* Content Section */}
      <div className="container max-w-6xl px-4 py-6 flex flex-col md:flex-row gap-10 md:gap-8 items-center">
        {/* Image */}
        <div className="w-full md:w-1/2 flex justify-center items-start">
          <div
            className="relative w-[220px] h-[300px] md:w-[358px] md:h-[500px]
        ...
        {/* Text Content */}
        <div className="w-full md:w-1/2 flex flex-col gap-6 text-center md:text-left text-xl md:text-2xl text-[#CCCCCC]">
          <p>
          ...
          <p>
            <span className="font-semibold text-white">Still unsure?</span>{" "}
            <br />
            Explore our Success Stories and see the results for yourself.
          </p>

          <div>
            <h3 className="font-bold text-white text-2xl md:text-4xl mb-4 md:mb-8">
              Who are we?
            </h3>
