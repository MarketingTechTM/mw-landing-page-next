  ...
  return (
    <div className="w-full bg-[#121212] text-white">
      ...
      <section className="w-full flex flex-col items-center justify-center bg-[#00718233] py-12 px-4 text-center">
        ...
        <p className="text-[#CFCFCF] text-lg sm:text-2xl">
      ...
      <section className="max-w-6xl mx-auto px-6 py-9 space-y-12">
        {/* Description */}
        <p className="text-[#C0C0C0] font-medium text-lg sm:text-2xl leading-7">
        ...
        <div className="space-y-6">
          <h2 className="text-3xl sm:text-4xl underline font-semibold text-[#007182] text-center">
            Definitions
          </h2>
          <p className="text-[#CFCFCF] font-medium text-base sm:text-2xl leading-7">
            {data.definitions.description}
          </p>

          <ul className="mt-6 space-y-6 list-disc list-inside text-xl marker:text-3xl ">
            {data.definitions.terms.map((term, index) => (
              <li key={index}>
                <span className="text-[#CFCFCF] font-medium text-base sm:text-2xl leading-7">
                  {term.title}
                  {": "}
                </span>
                <span className="text-[#CFCFCF] font-medium text-base sm:text-2xl leading-7">
        ...
        <section className="space-y-6">
          <h2 className="text-3xl sm:text-4xl font-bold underline text-[#007182]">
          ...
          <div className="space-y-2 pt-4">
            <h3 className="text-xl sm:text-2xl font-medium text-[#007182]">
              A. Personal Information You Provide Directly
            </h3>
            <p className="text-[#CFCFCF] text-base font-medium sm:text-2xl leading-7">
            ...
            <p className="text-[#CFCFCF] text-base sm:text-2xl leading-7 font-medium">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#CFCFCF] text-base sm:text-xl leading-7">
        ...
        <section className="space-y-6">
          ...
          <h3 className="text-xl sm:text-2xl font-medium text-[#007182] pt-2">
        ...
        {/* Contact Us */}
        <section className="space-y-6 pt-10 pb-16">
          <h2 className="text-3xl sm:text-4xl font-bold underline text-[#007182]">
            16. Contact Us
          </h2>
          <p className="text-[#C0C0C0] text-base sm:text-2xl leading-7">
