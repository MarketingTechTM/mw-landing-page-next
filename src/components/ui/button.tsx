...
export function CtaButton({
  ...
  const buttonContent = (
    ...
    >
      ...
      <span
        className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-6 py-1 font-medium text-white backdrop-blur-3xl ${textSize}`}
      >
        {title}
      </span>
    </button>
